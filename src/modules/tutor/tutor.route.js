...
import { getTutorsController, getTutorByIdController, createTutorController, updateTutorProfileController, AvailabilityController, getTutorSessions, } from "./tutor.controller";
...
router.post("/tutor/profile", authMiddleware(UserRole.TUTOR), createTutorController);
...
router.get("/sessions", authMiddleware(UserRole.TUTOR), getTutorSessions);
